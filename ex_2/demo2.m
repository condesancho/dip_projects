...
for k = 2:4
    ...
    cluster_d2a = mySpectralClustering(d2a_graph, k);
    ...
    % imwrite(d2a_new, ['2_a_',num2str(k),'.png']);

    % Same proccess for the d2b image
    cluster_d2b = mySpectralClustering(d2b_graph, k);
    ...
    % imwrite(d2b_new, ['2_b_',num2str(k),'.png']);
end
